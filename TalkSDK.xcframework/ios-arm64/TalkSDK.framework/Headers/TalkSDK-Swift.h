...
#ifndef TALKSDK_SWIFT_H
#define TALKSDK_SWIFT_H
...
/// Switch which reflects user’s <code>RecordingConsentAnswer</code>. The <code>on</code> state equals to <code>.optOut</code>, and <code>off</code> state to <code>.optIn</code>.
...
- (nonnull instancetype)initWithZendesk:(ZDKClassicZendesk * _Nonnull)zendesk;
